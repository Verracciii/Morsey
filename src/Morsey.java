...
public class Morsey {
	...
	public static void main(String[] args) {
		...
		// Create instances of the behaviours
		...
		Behavior battery = new BatteryVoltageBehavior(motorController, colorSensor, touchSensor, ultrasonicSensor);


		// Create an array of behaviours for the arbitrator
		Behavior[] behaviors = { touchInterrupt, exitHandler, obstacleAvoider, battery };
