...
public class MorseReaderBase {
    ...
    //  Method to decode Morse into letters
    public static Character decodeMorse(String morse) {
        return MORSE_CODE_MAP.containsKey(morse) ? MORSE_CODE_MAP.get(morse) : '?';  // '?' if not found
    }
 }